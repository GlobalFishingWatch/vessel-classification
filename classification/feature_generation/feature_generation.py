...
def read_input_fn(vessel_metadata, filenames, num_features, num_parallel_reads=4, random_state=None):
    ...
    path_ds = tf.data.Dataset.from_generator(lambda:filename_generator(filenames, random_state), tf.string)

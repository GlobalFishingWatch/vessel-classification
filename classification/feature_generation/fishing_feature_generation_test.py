...
fishing_ranges = metedata_mod.read_fishing_ranges(
    "classification/data/det_ranges_mmsi_v20200114.csv"
)
metadata = fishing_detection.Model.read_metadata(
    [b"416853000", b"204248000"],
    "classification/data/det_info_mmsi_v20200114.csv",
    fishing_ranges,
    "Training",
)

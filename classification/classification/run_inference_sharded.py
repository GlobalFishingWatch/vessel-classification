...
class Inferer(object):
    ...
    def run_inference(self, inference_parallelism, inference_results_path,
        ...
        with tf.Session(config=config) as sess:
            ...
            logging.info("Checking that destination dir is empty")
            assert not glob(os.path.join(inference_results_path, '*.json')), "destination dir {} not empty".format(repr(inference_results_path))
            ...
            while True:
                ...
                for result in zip(*batch_results):
                    ...
                    # Idea here: loop through data and split by date. 

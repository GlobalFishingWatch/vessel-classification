...
from . import layers_shakex2
from .model import ModelBase
from .objectives import LogRegressionObjectiveMAE, MultiClassificationObjective
...
class Model(ModelBase):
    ...
    def _build_net(self, features, timestamps, ids, is_training):
        outputs = layers_shakex2.shake2_model(
            features,
    ...
    def make_input_fn(self, base_feature_path, split, parallelism, prefetch):
        def input_fn():
            return (
                vessel_feature_generation.input_fn(
    ...
    def make_training_input_fn(self, base_feature_path, parallelism, prefetch=1024):
        return self.make_input_fn(
            base_feature_path, metadata.TRAINING_SPLIT, parallelism, prefetch
        )

    def make_test_input_fn(self, base_feature_path, parallelism, prefetch=1024):
        return self.make_input_fn(
            base_feature_path, metadata.TEST_SPLIT, parallelism, prefetch
        )
